...
import { deletePostComments } from '../../../redux/ActionCreators';
...
export default function AlertDialogSlide(props) {
    ...
    const onClick = React.useCallback((commentId) => 
        dispatch(deletePostComments(commentId))
        ,[dispatch]
    );

    function handleDeleteAnswer() {
        onClick(props.commentId);
        ...
        <div>
            ...
            >
                ...
                <DialogContentText id="alert-dialog-slide-description">
                    Are you sure about deleteting this comment?
                </DialogContentText>
                </DialogContent>
                <DialogActions>
