...
function Tags({classes}) {

  const [tagList, setTagList] = React.useState(['react', 'reactjs', 'django', 'drf', 'django-rest-framework', 'python', 'web-developing']);
  ...
  return (
    <div className={classes.root}>
        <ThemeProvider theme={theme}>
          <Grid container lg={8} sm xs={12} direction="column" justify="center" spacing={2}>
